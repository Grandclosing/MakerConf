...
window.onload = function () {
  ...
  fridayPosition = document.getElementById("friday").getBoundingClientRect()
    .top;
  saturdayPosition = document.getElementById("saturday").getBoundingClientRect()
    .top;
  sundayPosition = document.getElementById("sunday").getBoundingClientRect()
    .top;
...
function setDayBorder() {
  ...
  if (
    ...
    lastScrollPosition < saturdayPosition - scrollPositionOffset
  ) {
    newDay = FRIDAY;
  } else if (
    lastScrollPosition >= saturdayPosition - scrollPositionOffset &&
    lastScrollPosition < sundayPosition - scrollPositionOffset
  ) {
    newDay = SATURDAY;
