...
window.onload = function () {
  ...
  document.getElementById("email-display").innerHTML = queryObj[
    "email-entry"
  ].replace("%40", "@");
  ...
  if (queryObj.hasOwnProperty("phone-entry")) {
    ...
    confirmationNode.innerHTML = `You will receive schedule updates and reminder text messages at <span class="highlight">${
      formattedPhoneNumber ? formattedPhoneNumber : queryObj["phone-entry"]
    }</span>.`;
  }
};
